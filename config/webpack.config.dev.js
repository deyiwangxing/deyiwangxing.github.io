...
const WeinrePlugin = require('weinre-webpack').default;
...
module.exports = {
  ...
  plugins: [
    os.platform() !== 'win32' && new WeinrePlugin({
      defaultId: JSON.stringify('anonymous'), // define a default id, if define 'auto', it will give you a random id. format is `${platform}-${browser}-${uid}`
      ...
      httpPort: 8088, // if not define, it can use a idle port
